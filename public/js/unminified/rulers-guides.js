...
var RulersGuides = function (evt, dragdrop, container) {
    ...
    var doc         = document.documentElement,
        ...
        toggleRulers = function () {
            ...
            var zoomIn = document.getElementById('code-next-img-zoom-in');
            var zoomOut = document.getElementById('code-next-img-zoom-out');
            ...
            if (rulerStatus === 1) {
                ...
                wrapper.style.display = 'block';
                document.getElementById('code-next-ruler-icon').classList.remove("closed");
                removeInboundGuides();
            } else {
                zoomIn.click();
                document.getElementById('code-next-ruler-icon').classList.add("closed");
        ...
        Menu = function () {
            var menuList = null,
                ...
                toggles = {},
                menuItemsList  = [{
                    'text': codeNextParams.hideRulers,
                    'alias': 'rulers'
                }, {
                    'text': codeNextParams.hideGuides,
                    'alias': 'guides'
                }, {
                    'text': codeNextParams.clearAllGuides,
                    'alias': 'clear'
                }],
                i = 0;
            ...
            this.render = function () {
                ...
                evt.attach('mousedown', toggles.clear.obj, function () {
                    toggles.guides.txt.nodeValue = codeNextParams.hideGuides;
                    guideStatus = 1;
                    deleteGuides();
                    menu.close();
                });
                ...
                document.getElementById('code-next-ruler-icon').appendChild(menuBtn);
                document.getElementById('code-next-ruler-icon').appendChild(menuList);

                evt.attach('mousedown', menuBtn, function () {
                    toggles.rulers.txt.nodeValue = (rulerStatus === 1)
                        ? codeNextParams.hideRulers
                        : codeNextParams.showRulers;
                    ...
                    if (guidesCnt > 0) {
                        ...
                        toggles.guides.txt.nodeValue = (guideStatus === 1)
                            ? codeNextParams.hideGuides
                            : codeNextParams.showGuides;
                    } else {
