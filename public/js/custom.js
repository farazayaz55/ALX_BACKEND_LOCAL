(function ($) {
    ...
    $(document).ready(function () {
        /* Initialize code-next plugin */
        const pall = $("#code-next").codeNext({
            baseURL: "./", // The url of the main directory. For example; "http://www.mysite.com/code-next-js/"
            ...
            watermarkText: "https://code-next.website/", // The watermark text
            ...
            customFunctions: function (selector, canvas, lazyLoadInstance) {
                ...
                selector
                    ...
                    .on("click", ".template-favorite button.star", function () {
                        ...
                        // toastr.success("To make 'saving functions' work, you should have a database on your server and integrate it to code-next using a server-side language. See Documentation -> Integration.", "Info");
                ...
                selector
                    .find(".code-next-template-list")
                    .on("click", ".code-next-template-delete", function () {
                ...
                selector
                    .find("#code-next-library-upload-img")
                ...
                selector
                    ...
                    .on("click", ".code-next-library-delete", function () {
                        var answer = window.confirm(
                ...
                selector
                    .find("#code-next-svg-library-upload-img")
                    .on("change", function (e) {
                        var file_data = this.files[0];
                ...
                selector
                    ...
                    .on("click", ".code-next-svg-library-delete", function () {
                        var answer = window.confirm(
                            "Are you sure you want to delete the image permanently?"
                        );
                        if (answer) {
                ...
                // Save preferences
                selector
                    .find("#code-next-preferences-save")
                    .on("click", function () {
                        var button = $(this);
                        var settings = {};
                        var keys = [];
                        var values = [];
                        selector
                            .find("#code-next-preferences .preference")
            ...
            saveTemplate: function (selector, template) {
                ...
                // var name = selector.find('#code-next-json-save-name').val();
            ...
            saveImage: function (selector, imgData) {
                var name = selector.find("#code-next-save-img-name").val();
